...
import css from './LandingMenuPriority.css';

const EXTRA_SPACING_RIGHT = variables['--LandingMenuPriority_extraSpacingNoUnit'];
const LINK_SPACING = variables['--LandingMenuPriority_itemSpacingNoUnit'];
const ROUNDING_ERROR_MARGIN = 2;

class LandingMenuPriority extends Component {
  ...
  render() {
    ...
    return div({
      className: classNames('LandingMenuPriority', css.menuPriority, { [css.isMeasured]: isMeasured, [css.noPriorityLinks]: useFallback }),
      ref: (c) => {
...
export default LandingMenuPriority;
