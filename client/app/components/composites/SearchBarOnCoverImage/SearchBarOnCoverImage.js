...
import css from './SearchBarOnCoverImage.css';
...
class SearchBarOnCoverImage extends Component {
  constructor(props) {
    super(props);
  ...
  render() {
    ...
    // const bgColor = customColor || variables['--SearchBarOnCoverImage_mobileBackgroundColor'];
...
SearchBarOnCoverImage.propTypes = {
...
export default SearchBarOnCoverImage;
