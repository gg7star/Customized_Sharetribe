...
import TopbarWithOnlyMenu from './TopbarWithOnlyMenu';
...
const storifyTopbar = (props) => r(storify(r(TopbarWithOnlyMenu, props)), containerStyle);

const topbarWithSpecs = (props, spec) => {
  const component = r(TopbarWithOnlyMenu, props);
